...
class Player:
    ...
    def evaluate(self, board):
        ...
        return self.get_player_min_placements(board, self.enemy) - self.get_player_min_placements(board,
                                                                                                  self.player) + 1 / 1000 * (
                           len(player_hexes) - len(enemy_hexes)) + 1 / 100000 * get_centrality_score(player_hexes)
